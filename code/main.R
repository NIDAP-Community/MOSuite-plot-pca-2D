...
parser$add_argument("--principal_components", type="character", default="1,2", help="Principal components to plot (comma-separated)")
parser$add_argument("--legend_position", type="character", default="top", help="Position of the legend")
parser$add_argument("--point_size", type="double", default=1, help="Size of points in plot")
parser$add_argument("--add_label", type="logical", default=TRUE, help="Whether to add labels to points")
parser$add_argument("--label_font_size", type="double", default=3, help="Font size for labels")
parser$add_argument("--label_offset_x_", type="double", default=2, help="X-axis offset for labels")
